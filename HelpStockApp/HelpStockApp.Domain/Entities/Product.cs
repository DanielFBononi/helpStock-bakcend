...
namespace HelpStockApp.Domain.Entities
{
    public class Product : Entity
    {
        ...
        private void ValidateDomain(string name, string description, decimal price, int stock, string image)
        {
            ...
            DomainExceptionValidation.When(string.IsNullOrEmpty(image), "Invalid image URL, URL not a found or no exist");
            DomainExceptionValidation.When(description.Length > 50, "Invalid Description, Too Long, Maximum 50 characters");
